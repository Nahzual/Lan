...
class GamesController extends Controller
{
	...
	*/
	...
	/**
	* Adds the specified game to the logged user's favorite list
	*
	* @param  int  $id
	* @return \Illuminate\Http\Response
	*/
	...
	/**
	* Removes the specified game from the logged user's favorite list
	*
	* @param  int  $id
	* @return \Illuminate\Http\Response
	*/
	...
	/**
	* Shows the form to assign a port to the specified game for the specified LAN
	*
	* @param  int  $lanID
	* @param  int  $gameID
	* @return \Illuminate\Http\Response
	*/
	...
	/**
	* Assigns the specified port to the specified game for the specified LAN
	*
	* @param  \Illuminate\Http\Request  $request
	* @param  int  $lanID
	* @param  int  $gameID
	...
	*/
	...
	/**
	* Removes the specified port from the specified game for the specified LAN
	*
	* @param  \Illuminate\Http\Request  $request
	* @param  int  $lanID
	* @param  int  $gameID
	...
	*/
	...
	/**
	* Lists all the games whose name contains the specified string
	*
	* @param  \Illuminate\Http\Request  $request
	* @param  int  $lanID
	* @param  int  $gameID
